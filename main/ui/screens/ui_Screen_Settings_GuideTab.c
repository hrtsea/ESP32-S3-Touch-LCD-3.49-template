...
void ui_Screen_Settings_GuideTab_init(lv_obj_t *parent)
{
    ...
    lv_obj_set_style_text_color(ui_Settings_Textarea_UserGuide, theme.text, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_Settings_Textarea_UserGuide, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_Settings_Textarea_UserGuide, theme.bg, LV_PART_MAIN | LV_STATE_DEFAULT);
